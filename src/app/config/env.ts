...
const loadEnvVariable = (): EnvConfig => {
    const requareEnvVariable = ["PORT", "DB_URL", "NODE_ENV", "BCRYPT_SALT_ROUND", "JWT_ACCESS_EXPIRES", "JWT_ACCESS_SECRET", "SUPER_ADMIN_EMAIL", "SUPER_ADMIN_PASSWORD","JWT_REFRESH_SECRET","JWT_REFRESH_EXPIRES","GOOGLE_CLIENT_SECRET", "GOOGLE_CLIENT_ID", "GOOGLE_CALLBACK_URL", "EXPRESS_SESSION_SECRET", "FRONTEND_URL","STORE_ID","STORE_PASS","SSL_PAYMENT_API","SSL_VALIDATION_API", "SSL_SUCCESS_FRONTEND_URL",
